...
import numpy as np
import pandas as pd
from utils.data_processing import convert_df_to_list
...
def print_predicted_and_true_data(predicted, true):
    ...
    for i in range(len(true)):
        print("Predicted: " + str(np.round(predicted[i][0] * (8.82 - 0.0) + 0.0, 2)) + "; True: " + str(np.round(true[i] * (8.82 - 0.0) + 0.0, 2)))
